...
public class AuctionSaveServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public AuctionSaveServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) {
		...
		String result = auctionService.auctionSave(request, response,
				getServletConfig());

		try {
			request.getRequestDispatcher(
					"AuctionListServlet?msg=" + result + "").forward(request,
					response);
		} catch (Exception e) {
			e.printStackTrace();
		}
